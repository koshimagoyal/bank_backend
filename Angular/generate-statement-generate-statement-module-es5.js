...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["generate-statement-generate-statement-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppGenerateStatementDialogComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppGenerateStatementGenerateStatementComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppGenerateStatementDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var pdfmake_build_vfs_fonts__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(pdfmake_build_vfs_fonts__WEBPACK_IMPORTED_MODULE_5__); // @ts-ignore
    ...
    var DialogComponent = /*#__PURE__*/function () {
      ...
      _createClass(DialogComponent, [{
        key: "createAccountBody",
        value: function createAccountBody(data) {
          var _this = this;
          ...
          data.forEach(function (val) {
            if (val.account.credit === null) {
              if (_this.isDate(val.account.date)) {
                body.push([moment__WEBPACK_IMPORTED_MODULE_3___default()(val.account.date).format('DD-MM-YYYY'), val.account.particulars.toString(), val.account.mode.toString(), {
                  text: '-',
                  fillColor: '#7CFC00'
                }, {
            ...
            if (val.cheque) {
              body.push([_this.createChequeTable(val.cheque), {}, {}, {}, {}]);
            }
          });
          console.log(body);
          return body;
        ...
        value: function createChequeBody(data) {
          ...
          data.forEach(function (val) {
            ...
            if (_this2.isDate(val.chequeDate)) {
              body.push([{
        ...
        value: function createLoanBody(data) {
          ...
          body.push(columns);
          data.forEach(function (val) {
            if (_this3.isDate(val.loanData.date)) {
              if (_this3.isDate(val.loanData.dateOfClosure)) {
                if (val.loanData.closeLoan === 0) {
                  body.push([moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.date).format('DD-MM-YYYY'), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'No', val.loanData.closeStatus.toString(), moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.dateOfClosure).format('DD-MM-YYYY')]);
                } else {
                  body.push([moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.date).format('DD-MM-YYYY'), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'Yes', val.loanData.closeStatus.toString(), moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.dateOfClosure).format('DD-MM-YYYY')]);
                }
              } else {
                if (val.loanData.closeLoan === 0) {
                  body.push([moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.date).format('DD-MM-YYYY'), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'No', val.loanData.closeStatus, val.loanData.dateOfClosure]);
                } else {
                  body.push([moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.date).format('DD-MM-YYYY'), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'Yes', val.loanData.closeStatus, val.loanData.dateOfClosure]);
                }
              }
            } else {
              if (_this3.isDate(val.loanData.dateOfClosure)) {
                if (val.loanData.closeLoan === 0) {
                  body.push([val.loanData.date.toString(), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'No', val.loanData.closeStatus, moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.dateOfClosure).format('DD-MM-YYYY')]);
                } else {
                  body.push([val.loanData.date.toString(), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'Yes', val.loanData.closeStatus, moment__WEBPACK_IMPORTED_MODULE_3___default()(val.loanData.dateOfClosure).format('DD-MM-YYYY')]);
                }
              } else {
                if (val.loanData.closeLoan === 0) {
                  body.push([val.loanData.date.toString(), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'No', val.loanData.closeStatus, val.loanData.dateOfClosure]);
                } else {
                  body.push([val.loanData.date.toString(), val.loanData.loanAmount.toString(), val.loanData.loanDuration.toString(), val.loanData.loanType.toString(), 'Yes', val.loanData.closeStatus, val.loanData.dateOfClosure]);
                }
              }
            }

            if (val.loanBook) {
              body.push([_this3.createLoanBookTable(val.loanBook), {}, {}, {}, {}, {}, {}]);
            }

            if (val.closeData) {
              body.push([_this3.createCloseTable(val.closeData, val.loanData, val.chequeData), {}, {}, {}, {}, {}, {}]);
            }
          });
          console.log(body);
          return body;
        ...
        value: function onConfirmClick() {
          ...
          var docDefinition = {
            ...
            {
              text: document.getElementById('subDetail1').innerText,
              style: 'subheader'
            }, {
              style: 'tableExample',
              table: {
            ...
            {
              text: document.getElementById('subDetail2').innerText,
              style: 'subheader'
            }, {
              style: 'tableExample',
              table: {
    ...
    DialogComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/generate-statement/dialog.component.html"))["default"]
  ...
  /***/
  function srcAppGenerateStatementGenerateStatementRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GenerateStatementRoutingModule", function () {
      return GenerateStatementRoutingModule;
    });
    /* harmony import */
    ...
    var _generate_statement_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./generate-statement.component */
    "./src/app/generate-statement/generate-statement.component.ts");

    var routes = [{
      path: '',
      component: _generate_statement_component__WEBPACK_IMPORTED_MODULE_3__["GenerateStatementComponent"]
    }];

    var GenerateStatementRoutingModule = function GenerateStatementRoutingModule() {
      _classCallCheck(this, GenerateStatementRoutingModule);
    };

    GenerateStatementRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppGenerateStatementGenerateStatementComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppGenerateStatementGenerateStatementComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GenerateStatementComponent", function () {
      return GenerateStatementComponent;
    });
    /* harmony import */
    ...
    var _app_generate_statement_dialog_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @app/generate-statement/dialog.component */
    "./src/app/generate-statement/dialog.component.ts");
    /* harmony import */


    var _app_generate_statement_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/generate-statement/services */
    ...
    var GenerateStatementComponent = /*#__PURE__*/function () {
      function GenerateStatementComponent(dialog, snackBar, generateService, fb) {
        _classCallCheck(this, GenerateStatementComponent);
      ...
      _createClass(GenerateStatementComponent, [{
        key: "showTable",
        value: function showTable() {
          ...
          this.generateService.getData(this.text).subscribe(function (result) {
            console.log(result);
            ...
            if (result.nameData.length === 0) {
              ...
              for (var i = 0; i < result.balance.length; i++) {
                _this5.balance = _this5.balance + result.balance[i].credit - result.balance[i].debit;
              }

              _this5.name = result.nameData[0].name;
              _this5.table = true;
            }
          }, function (error1) {
            sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
        ...
        value: function openDialog() {
          ...
          this.generateService.getDialogData(data).subscribe(function (result) {
            console.log(result);
            ...
            if (result.accountData.length === 0) {
              ...
              console.log(result);
              _this6.accountData = result.accountData;
              _this6.loanData = result.loanData;

              var dialogRef = _this6.dialog.open(_app_generate_statement_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"], {
                data: {
                  id: _this6.text,
                  name: _this6.name,
                  // @ts-ignore
                  start: _this6.reportForm.get('start').value,
                  // @ts-ignore
                  end: _this6.reportForm.get('end').value,
                  balance: _this6.balance,
                  accountData: _this6.accountData,
                  loanData: _this6.loanData
                },
                height: '600px',
                width: '800px'
              });
              ...
              dialogRef.afterClosed().subscribe(function (res) {
                if (res) {
                  _this6.table = false;
                  _this6.searchForm = _this6.fb.group({
                    employeeNo: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required]))
                  });
                  _this6.reportForm = _this6.fb.group({
                    start: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required])),
                    end: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required]))
                  });
                }
    ...
    GenerateStatementComponent.ctorParameters = function () {
      return [{
    ...
    GenerateStatementComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'sb-generate-statement',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./generate-statement.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/generate-statement/generate-statement.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./generate-statement.component.scss */
      "./src/app/generate-statement/generate-statement.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"], _app_generate_statement_services__WEBPACK_IMPORTED_MODULE_5__["GenerateStatementService"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormBuilder"]])], GenerateStatementComponent);
    /***/
  },
  ...
  /***/
  function srcAppGenerateStatementGenerateStatementModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GenerateStatementModule", function () {
      return GenerateStatementModule;
    });
    /* harmony import */
    ...
    var _generate_statement_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./generate-statement-routing.module */
    "./src/app/generate-statement/generate-statement-routing.module.ts");
    /* harmony import */


    var _generate_statement_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./generate-statement.component */
    "./src/app/generate-statement/generate-statement.component.ts");
    /* harmony import */
    ...
    var _app_layout_dashboard_layout_dashboard_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @app/layout-dashboard/layout-dashboard.module */
    "./src/app/layout-dashboard/layout-dashboard.module.ts");

    var GenerateStatementModule = function GenerateStatementModule() {
      _classCallCheck(this, GenerateStatementModule);
    };

    GenerateStatementModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _generate_statement_routing_module__WEBPACK_IMPORTED_MODULE_8__["GenerateStatementRoutingModule"], _app_navigation_navigation_module__WEBPACK_IMPORTED_MODULE_5__["NavigationModule"], _app_app_common_app_common_module__WEBPACK_IMPORTED_MODULE_4__["AppCommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__["MatDialogModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_12__["MatSnackBarModule"], _app_layout_dashboard_layout_dashboard_module__WEBPACK_IMPORTED_MODULE_13__["LayoutDashboardModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
  ...
  /***/
  function srcAppGenerateStatementServicesGenerateStatementServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GenerateStatementService", function () {
    ...
    var GenerateStatementService = /*#__PURE__*/function () {
      function GenerateStatementService(http) {
        _classCallCheck(this, GenerateStatementService);

        this.http = http;
      }

      _createClass(GenerateStatementService, [{
        key: "getData",
        ...
        value: function getDialogData(data) {
          var url = 'http://drsunitanayak.com/getAllUserData';
          return this.http.post(url, data);
        }
      }]);
    ...
    GenerateStatementService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
      }];
    };

    GenerateStatementService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])], GenerateStatementService);
    /***/
  },
  ...
  /***/
  function srcAppGenerateStatementServicesIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _generate_statement_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    __webpack_require__.d(__webpack_exports__, "GenerateStatementService", function () {
      return _generate_statement_service__WEBPACK_IMPORTED_MODULE_1__["GenerateStatementService"];
    });

    var services = [_generate_statement_service__WEBPACK_IMPORTED_MODULE_1__["GenerateStatementService"]];
    /***/
  }
}]);
//# sourceMappingURL=generate-statement-generate-statement-module-es5.js.map