...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["employee-dashboard-employee-dashboard-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppEmployeeDashboardEmployeeDashboardEmployeeDashboardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEmployeeDashboardEmployeeDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmployeeDashboardRoutingModule", function () {
      return EmployeeDashboardRoutingModule;
    });
    /* harmony import */
    ...
    var _app_employee_dashboard_employee_dashboard_employee_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @app/employee-dashboard/employee-dashboard/employee-dashboard.component */
    "./src/app/employee-dashboard/employee-dashboard/employee-dashboard.component.ts");

    var routes = [{
      path: '',
      component: _app_employee_dashboard_employee_dashboard_employee_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["EmployeeDashboardComponent"]
    }];

    var EmployeeDashboardRoutingModule = function EmployeeDashboardRoutingModule() {
      _classCallCheck(this, EmployeeDashboardRoutingModule);
    };

    EmployeeDashboardRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppEmployeeDashboardEmployeeDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmployeeDashboardModule", function () {
    ...
    var _employee_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./employee-dashboard-routing.module */
    "./src/app/employee-dashboard/employee-dashboard-routing.module.ts");
    /* harmony import */
    ...
    var EmployeeDashboardModule = function EmployeeDashboardModule() {
      _classCallCheck(this, EmployeeDashboardModule);
    };

    EmployeeDashboardModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_employee_dashboard_employee_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["EmployeeDashboardComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _employee_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["EmployeeDashboardRoutingModule"], _app_layout_emp_dashboard_layout_emp_dashboard_module__WEBPACK_IMPORTED_MODULE_5__["LayoutEmpDashboardModule"], _app_navigation_navigation_module__WEBPACK_IMPORTED_MODULE_6__["NavigationModule"], _app_app_common_app_common_module__WEBPACK_IMPORTED_MODULE_7__["AppCommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__["TranslateModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_10__["NgxPaginationModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_11__["Ng2SearchPipeModule"]]
  ...
  /***/
  function srcAppEmployeeDashboardEmployeeDashboardEmployeeDashboardComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEmployeeDashboardEmployeeDashboardEmployeeDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_employee_dashboard_services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @app/employee-dashboard/services */
    ...
    var EmployeeDashboardComponent = /*#__PURE__*/function () {
      function EmployeeDashboardComponent(dashboardService, session) {
      ...
      _createClass(EmployeeDashboardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var text = this.user.id;
          console.log(text);
          this.dashboardService.getData(text).subscribe(function (result) {
            if (result) {
              console.log(result);
              _this.show = [result.loanData.length];
              _this.q = new Array(result.loanData.length); // tslint:disable-next-line:prefer-for-of

              for (var i = 0; i < result.loanData.length; i++) {
                var principle = result.loanData[i].loanData.loanAmount;
                _this.loanAmount += principle;
                var r = result.loanData[i].loanData.interest / 100;

                if (result.loanData[i].loanBook) {
                  // tslint:disable-next-line:prefer-for-of
                  for (var j = 0; j < result.loanData[i].loanBook.length; j++) {
                    var emi = result.loanData[i].loanBook[j].credit;
                    var amt = emi * r;
                    principle -= amt;
                    _this.emi += emi;
                ...
                _this.loanDebit += principle;
                console.log(_this.loanDebit);
                _this.show[i] = false;
              }

              _this.amount = (Math.round(_this.loanDebit * 100) / 100).toFixed(0); // tslint:disable-next-line:prefer-for-of

              for (var _i = 0; _i < result.accountData.length; _i++) {
                _this.balance += result.accountData[_i].account.credit - result.accountData[_i].account.debit;
              }

              _this.account = result.accountData;
              _this.loans = result.loanData;
            }
          }, function (error1) {
        ...
        key: "showTable",
        value: function showTable(event) {
          console.log(event);
    ...
    EmployeeDashboardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'sb-employee-dashboard',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./employee-dashboard.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/employee-dashboard/employee-dashboard/employee-dashboard.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./employee-dashboard.component.scss */
      "./src/app/employee-dashboard/employee-dashboard/employee-dashboard.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_app_employee_dashboard_services__WEBPACK_IMPORTED_MODULE_2__["DashboardService"], ngx_webstorage__WEBPACK_IMPORTED_MODULE_3__["SessionStorageService"]])], EmployeeDashboardComponent);
    /***/
  },
  ...
  /***/
  function srcAppEmployeeDashboardServicesDashboardServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var DashboardService = /*#__PURE__*/function () {
      ...
      _createClass(DashboardService, [{
        ...
        value: function getData(text) {
          ...
          var url = 'http://drsunitanayak.com/get/userData';
  ...
  /***/
  function srcAppEmployeeDashboardServicesIndexTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=employee-dashboard-employee-dashboard-module-es5.js.map